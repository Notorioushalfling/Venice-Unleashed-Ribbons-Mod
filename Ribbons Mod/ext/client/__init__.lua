...
function drawRibbon(ribbon)
    ...
    -- Calculate position to center the ribbon at the top of the screen
    local x = (screenWidth - ribbonWidth) / 2
    local y = 50 -- Display the ribbon 50 pixels from the top
...
NetEvents:Subscribe('DisplayRibbon', function(ribbonName)
    ...
    print("Received DisplayRibbon event for: " .. ribbonName)
end)
